...
export const Route = createFileRoute("/case-studies/")({
  head: () =>
    pageSocialHead({
      title: `Case Studies: Clinical Trial Simulation Across Safety, Oncology, Biologics | ${PRODUCT_NAME}`,
      description: `Three anonymized ClinicalSim engagements: Phase II hepatotoxicity prediction, oncology PK/PD dose optimization, and autoimmune biologic trial success probability. Real predicted vs. observed outcomes.`,
      canonical: `${SITE_ORIGIN}/case-studies`,
      ogTitle: `${PRODUCT_NAME} Case Studies`,
      ogDescription: `Real results from clinical trial simulation: DILI prediction, dose optimization, and Phase III success probability modeling.`,
    }),
...
function CaseStudiesIndexPage() {
  return (
    <SiteLayout>
        ...
        <div className="section-inner relative z-10 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 font-display text-4xl tracking-tight text-[var(--charcoal)] sm:text-5xl">
              Real programs.{" "}
              <span className="gold-gradient">Predicted vs. observed.</span>
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              Client identities are anonymized at their request, but every metric below is from a
              closed engagement with downstream clinical outcome confirmation.
            </p>
      ...
      <PageSection
        eyebrow="By domain"
        title="Three programs across clinical simulation modalities"
        description="Select a case study to read the full simulation timeline, dose scenario rankings, predicted vs. observed outcomes, and ROI analysis."
        tone="parchment"
      >
