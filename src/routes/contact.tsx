...
export const Route = createFileRoute("/contact")({
  head: () =>
    pageSocialHead({
      title: `Contact ClinicalSim: Schedule a Clinical Simulation Consultation | ${PRODUCT_NAME}`,
      ...
      ogDescription: `Schedule a 30-minute intro call or request a simulation quote for your Phase II or Phase III program.`,
    }),
      ...
      <section className="border-b border-border bg-[var(--parchment)]">
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
            ...
            whether a clinical simulation fits your phase transition timeline.
          </p>
        </div>
      </section>
          ...
          {sent ? (
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <SelectField label="Project type" name="project_type" options={["Toxicity / DILI prediction", "PK/PD dose optimization", "Trial success probability", "Adaptive design simulation", "Custom / not sure yet"]} />
              </div>
              <SelectField label="Timeline" name="timeline" options={["ASAP (before Phase II start)", "Next quarter", "Exploring options"]} />
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-muted-foreground">Tell us about your program</label>
